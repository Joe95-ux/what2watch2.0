...
export function usePlaylistAnalytics(params: AnalyticsParams = {}) {
  ...
  useEffect(() => {
    ...
    channel.bind(PUSHER_EVENTS.PLAYLIST_ANALYTICS_UPDATED, handleAnalyticsUpdate);
    return () => {
      channel.unbind(PUSHER_EVENTS.PLAYLIST_ANALYTICS_UPDATED, handleAnalyticsUpdate);
    };
