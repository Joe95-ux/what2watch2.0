            ...
            <TooltipTrigger asChild>
              <div>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-[min(18rem,calc(100vw-2rem))] flex flex-col overflow-hidden p-1"
                  >
                    <DropdownMenuLabel className="text-xs font-semibold normal-case">
                      Keyword
                    </DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <div className="max-h-[min(60vh,320px)] min-h-0 overflow-y-auto scrollbar-thin py-1">
                      <DropdownMenuItem
                      ...
                      {keywordOptions.length === 0 ? (
                        ...
                        keywordOptions.map((kw) => (
                          <DropdownMenuItem
                            ...
                            className={cn(
                              "cursor-pointer whitespace-normal h-auto min-h-8 items-start",
