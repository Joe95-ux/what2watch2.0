...
export function YouTubeChannelCardPage({ channel }: YouTubeChannelCardPageProps) {
  ...
  return (
    ...
    >
      ...
      {/* Note — truncated; tap to read full text */}
      {channel.note && (
        <>
          <div className="mt-3 mb-3">
            <button
              ...
              className="text-sm text-muted-foreground line-clamp-2 text-center w-full cursor-pointer hover:text-foreground hover:underline underline-offset-2 transition-colors"
            >
              {channel.note}
            </button>
          </div>
