...
import { Upload, FileText, XCircle, AlertCircle, Loader2 } from "lucide-react";
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="mx-auto w-full max-w-[calc(100vw-1rem)] sm:max-w-3xl lg:max-w-[50rem] max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin px-1">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                className="hidden"
                id="csv-file-input-playlist"
              />
              <label htmlFor="csv-file-input-playlist">
                <Button
                  type="button"
                  variant="outline"
          ...
          {/* Preview & Validation - Same as list modal */}
          {preview && validation && (
            <>
              <div className="space-y-2">
