  ...
  const handleDateUpdate = async () => {
    ...
    try {
      if (editingLog.type === "episodeLog") {
        if (
          editingLog.episodeNumbers &&
          editingLog.episodeNumbers.length > 1 &&
          editingLog.seasonNumber !== undefined
        ) {
                    ...
                    <div className="bg-card border rounded-lg p-4 space-y-3">
                      ...
                      {mediaType === "tv" && episodeInfo && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">{episodeInfo}</span>
                        </div>
                      )}
